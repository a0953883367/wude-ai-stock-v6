...
def test_us_summer_connection_starts_at_1600_premarket_and_crosses_midnight():
    assert not market_live_window("US", at("2026-08-31T15:59:00"))
    assert market_live_window("US", at("2026-08-31T16:00:00"))
    assert market_live_window("US", at("2026-08-31T21:29:00"))
...
def test_us_winter_session_follows_new_york_clock_until_0500_taipei():
    assert not market_live_window("US", at("2026-12-01T16:59:00"))
    assert market_live_window("US", at("2026-12-01T17:00:00"))
    assert market_live_window("US", at("2026-12-01T22:29:00"))
